...
if __name__ == "__main__":
    ...
    basic_info, wide_config, deep_config = train_dataset.generate_config()
    model = DeepFM(
    ...
    for batch in train_loader:
        dense, sparse, seq_dense, link_id, link_len, label, order_id = batch
        print(model(dense, sparse, seq_dense, link_id, link_len).shape)
        break
